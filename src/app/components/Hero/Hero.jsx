  ...
  return (
    <div className="mx-auto max-w-[1700px] px-4 mt-10">
      <div className="flex flex-wrap justify-center gap-6 lg:flex-nowrap">
        {/* First Card */}
        <div className="relative bg-[#54A6FF] text-white flex flex-col rounded-lg pt-8 pl-8 pb-4 w-full max-w-[550px] sm:px-6 lg:flex-1">
          <img
        ...
        {/* Second Card */}
        <div className="relative bg-[#3563E9] text-white flex flex-col rounded-lg pt-8 pl-8 pb-4 w-full max-w-[550px] sm:px-6 lg:flex-1">
          <img
